...
function App() {
  ...
  return (
    <main className="bg-[url('/image/bg01.jpeg')] bg-center min-h-screen text-slate-950 font-extrabold">
      <section className= "mb-5 bg-[url('/image/bg-h1.jpg')] flex flex-col items-center bg-cover pb-[10%]">
        <LocationForm handelSubmit={handelSubmit} />
